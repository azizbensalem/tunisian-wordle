...
export const tunisianWords: TunisianWord[] = [
  ...
  { arabic: "برتقال", length: getArabicLength("برتقال") },
  { arabic: "موز", length: getArabicLength("موز") },
  { arabic: "فراز", length: getArabicLength("فراز") },
  { arabic: "عنب", length: getArabicLength("عنب") },
  ...
  { arabic: "الجزائر", length: getArabicLength("الجزائر") },
  { arabic: "المغرب", length: getArabicLength("المغرب") },
  { arabic: "ليبيا", length: getArabicLength("ليبيا") },
  { arabic: "فرانسا", length: getArabicLength("فرانسا") },
  { arabic: "إيطاليا", length: getArabicLength("إيطاليا") },
  { arabic: "مصر", length: getArabicLength("مصر") },
  { arabic: "السعودية", length: getArabicLength("السعودية") },
  { arabic: "الإمارات", length: getArabicLength("الإمارات") },
  { arabic: "ألمانيا", length: getArabicLength("ألمانيا") },
  { arabic: "أمريكيا", length: getArabicLength("أمريكيا") },
  { arabic: "كندا", length: getArabicLength("كندا") },
  { arabic: "تركيا", length: getArabicLength("تركيا") },
  { arabic: "قطر", length: getArabicLength("قطر") },
  { arabic: "الكويت", length: getArabicLength("الكويت") },
  { arabic: "البحرين", length: getArabicLength("البحرين") },
  { arabic: "سوريا", length: getArabicLength("سوريا") },
  { arabic: "لبنان", length: getArabicLength("لبنان") },
  { arabic: "الأردن", length: getArabicLength("الأردن") },
  { arabic: "العراق", length: getArabicLength("العراق") },
  { arabic: "الصومال", length: getArabicLength("الصومال") },
  { arabic: "إيران", length: getArabicLength("إيران") },
  { arabic: "البرازيل", length: getArabicLength("البرازيل") },
  { arabic: "الأرجنتين", length: getArabicLength("الأرجنتين") },
  { arabic: "المكسيك", length: getArabicLength("المكسيك") },
  { arabic: "اليمن", length: getArabicLength("اليمن") },
  { arabic: "العاصمة", length: getArabicLength("العاصمة") },
  { arabic: "صفاقس", length: getArabicLength("صفاقس") },
  { arabic: "سوسة", length: getArabicLength("سوسة") },
  { arabic: "القيروان", length: getArabicLength("القيروان") },
  { arabic: "بنزرت", length: getArabicLength("بنزرت") },
  { arabic: "قفصة", length: getArabicLength("قفصة") },
  { arabic: "مدنين", length: getArabicLength("مدنين") },
  { arabic: "تطاوين", length: getArabicLength("تطاوين") },
  { arabic: "جرجيس", length: getArabicLength("جرجيس") },
  { arabic: "توزر", length: getArabicLength("توزر") },
  { arabic: "نابل", length: getArabicLength("نابل") },
  { arabic: "المهدية", length: getArabicLength("المهدية") },
  { arabic: "الكاف", length: getArabicLength("الكاف") },
  { arabic: "باجة", length: getArabicLength("باجة") },
  { arabic: "القصرين", length: getArabicLength("القصرين") },
  { arabic: "سليانة", length: getArabicLength("سليانة") },
  { arabic: "زغوان", length: getArabicLength("زغوان") },
  { arabic: "قبلي", length: getArabicLength("قبلي") },
  ...
  { arabic: "بصل", length: getArabicLength("بصل") },
  { arabic: "ثوم", length: getArabicLength("ثوم") },
  { arabic: "سفنارية", length: getArabicLength("سفنارية") },
  ...
  // Time units
    ...
    { arabic: "شهر", length: getArabicLength("شهر") },
    { arabic: "سنة", length: getArabicLength("سنة") },
    { arabic: "قرن", length: getArabicLength("قرن") },
    { arabic: "نص", length: getArabicLength("نص") },
    { arabic: "توا", length: getArabicLength("توا") },
    { arabic: "غدوة", length: getArabicLength("غدوة") },
    { arabic: "البارح", length: getArabicLength("البارح") },
    { arabic: "عشية", length: getArabicLength("عشية") },
    ...
    { arabic: "ليل", length: getArabicLength("ليل") },
    { arabic: "نهار", length: getArabicLength("نهار") },
    { arabic: "مؤقت", length: getArabicLength("مؤقت") },
    { arabic: "ساعات", length: getArabicLength("ساعات") },
    { arabic: "وقت", length: getArabicLength("وقت") },
    { arabic: "فترة", length: getArabicLength("فترة") },
    { arabic: "متقطع", length: getArabicLength("متقطع") },
    { arabic: "لحظة", length: getArabicLength("لحظة") },
    { arabic: "مدة", length: getArabicLength("مدة") },
    { arabic: "فيسع", length: getArabicLength("فيسع") },
